...
#  User.create(email:'spencerblum@gmail.com', password: '1', first_name: 'Spencer', last_name: 'Blum', imageurl: "https://dl.airtable.com/.attachmentThumbnails/1ee9b5b0a9245281bd7857835ef256d8/ebb993b2",is_owner:true )
 ...
 User.create(email:'guest@gmail.com', password: '1', first_name: 'guest', last_name: 'guest', imageurl: "https://upload.wikimedia.org/wikipedia/commons/thumb/4/46/Leonardo_Dicaprio_Cannes_2019.jpg/220px-Leonardo_Dicaprio_Cannes_2019.jpg",is_owner:true )
